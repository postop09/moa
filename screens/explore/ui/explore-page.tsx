...
import { ExternalLink, IconSymbol, ThemedText, ThemedView } from '@/shared/ui';
    ...
    >
      ...
      <Collapsible title="Animations">
        <ThemedText>
          ...
          <ThemedText type="defaultSemiBold">HelloWave</ThemedText> component
          uses the powerful{' '}
        ...
        {Platform.select({
          ios: (
            <ThemedText>
              ...
              widget provides a parallax effect for the header image.
            </ThemedText>
          ),
        })}
      </Collapsible>
